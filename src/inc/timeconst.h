...
#define TIMECONST_H_
	...
	const int MAX_FSIZE_DRV_YR = 109; // maximum number of years of fire size at regional-scale (YUAN);

	//YUAN: moving the constants in Timer here
	const int MAX_EQ_YR = 6000;  // maximum number of years for equilibrium run

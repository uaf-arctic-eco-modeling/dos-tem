...
void RunGrid::setGridInputer(GridInputer * gin){
  	ginputer= gin;
};
...
/*
void RunGrid::grdOutput(const int & outputyrind, const int & currmind){
  
};

void RunGrid::setOutputer(AtmosphereOutputer *satmoutp){
